...
function setup() {
	...
	roof = Bodies.rectangle(400,100,230,40,roof_options);
    World.add(world,roof);

	bob1 = Bodies.circle(300,300,50, bob_options)
	World.add(world, bob1);

	bob2 = Bodies.circle(350,300,50, bob_options)
	World.add(world, bob2);

	bob3 = Bodies.circle(400,300,50, bob_options)
	World.add(world, bob3);

	bob4 = Bodies.circle(450,300,50, bob_options)
	World.add(world, bob4);

	bob5 = Bodies.circle(500,300,50, bob_options)
...
function keyPressed(){
	if(keyCode===UP_ARROW){
	  Matter.Body.applyForce(bob1,{x:0, y:0},{x:-3,y:0});
	}
 }